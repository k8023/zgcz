<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:45:"./application/admin/template/images\index.htm";i:1596507477;s:79:"E:\phpstudy\EyouCMS-1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:77:"E:\phpstudy\EyouCMS-1.4.9-UTF8-SP2\application\admin\template\article\bar.htm";i:1573115083;s:83:"E:\phpstudy\EyouCMS-1.4.9-UTF8-SP2\application\admin\template\archives\tags_btn.htm";i:1602320133;s:79:"E:\phpstudy\EyouCMS-1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
                        ...
                        <tr>
                            ...
                            <td style="width: 100%;">
                                <div class="tl" style="padding-left: 10px;">
                                    ...
                                    <a href="<?php echo url('Images/edit',array('id'=>$vo['aid'])); ?>" style="<?php if($vo['is_b'] == '1'): ?> font-weight: bold;<?php endif; ?>"><?php echo $vo['title']; ?></a>
                                    <?php else: ?>
                            ...
                            <td align="center" class="">
                                <div class="w100 tc"><a href="<?php echo url('Images/index', array('typeid'=>$vo['typeid'], 'tab'=>3)); ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a></div>
                            </td>
                            <td align="center" class="">
                                <div class="tc w50">
        ...
        <div class="footer-oper">
            ...
            <div class="nav-dropup">
                ...
                <div class="dropdown-menus" style="display:none;">
                    ...
                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                    <a href="javascript:void(0);" onclick="batch_del(this, 'ids');" data-url="<?php echo url('Images/del'); ?>" data-deltype="pseudo"><i class="fa fa-close"></i>删除文档</a>
