<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/tools\index.htm";i:1596507477;s:79:"E:\phpstudy\EyouCMS-1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:75:"E:\phpstudy\EyouCMS-1.4.9-UTF8-SP2\application\admin\template\tools\bar.htm";i:1571728724;s:79:"E:\phpstudy\EyouCMS-1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <div class="fbutton">
                    <a id="ing_btn">
                        <div class="add" title="数据备份">
                            <span><i class="fa fa-book"></i><span onclick="$('.export_btn').trigger('click');">数据备份</span></span>
                        </div>
                    </a>
                </div>
            <?php endif; ?>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    <a id="ing_btn">
                        <div class="add" title="数据备份">
                            <span><i class="fa fa-book"></i><span class="export_btn">数据备份</span></span>
                        </div>
                    </a>
                </div>
                <?php endif; ?>
