<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/lists_search.htm";i:1571728724;s:57:"E:\phpstudy\EyouCMS-1.4.9-UTF8-SP2\template\pc\header.htm";i:1587952662;s:57:"E:\phpstudy\EyouCMS-1.4.9-UTF8-SP2\template\pc\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--搜索页seo标题-->
<title>搜索页_<?php echo $eyou['field']['keywords']; ?>_<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_name"); echo $__VALUE__; ?></title>
<!--搜索页seo关键词-->
...
<!--网站公用头部——结束-->
<div class="bg_inner  arctype_id_search" >
  <div class="banner_inner width" >
    <div class="con">搜索结果<span>Search Result</span>
    </div>
  </div>
</div>
...
<ol class="am-breadcrumb">
    ...
    <li><a>站内搜索</a></li>
    <li class="am-active"><?php echo $eyou['field']['keywords']; ?></li>
  </ol>
  <!--搜索关键词调用-->
  <h1><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:4:"sys7";}'); echo $__VALUE__; ?> <strong><?php echo $eyou['field']['keywords']; ?></strong> <?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:6:"yybl12";}'); echo $__VALUE__; ?></h1>
